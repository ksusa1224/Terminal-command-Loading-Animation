...
public class Constant {
	// MAC
	/* 
	public static final String ANKI_NOTE_ROOT_PATH = "/usr/local/anki_note/";
	public static final String ANKI_NOTE_FOLDER_PASSWORD = "Xdsjiafr8FSfjIORFJSIOE+U";
	public static final String DB_FOLDER_PATH = "/usr/local/anki_note/databases/";
	public static final String H2DB_FOLDER_PATH = "/usr/local/anki_note/databases/h2db/";
	public static final String SQLITE_FOLDER_PATH = "/usr/local/anki_note/databases/sqlite/";
	public static final String SQLITE_LOG_FOLDER_PATH = "/usr/local/anki_note/databases/sqlite/data/log_db/";
	public static final String SQLITE_USER_DB_FOLDEDR_PATH = "/usr/local/anki_note/databases/sqlite/data/user_db/";
	*/
	// WINDOWS
